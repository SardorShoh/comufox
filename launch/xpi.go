...
func contains(slice []string, item string) bool { return slices.Contains(slice, item) }

// Returns the absolute path to the target addon location
func getAddonPath(addonName string) string { return getPath(filepath.Join("addons", addonName)) }
